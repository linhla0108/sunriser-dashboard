    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ orientation, className, ...iconProps }) => {
          ...
          return <ChevronDown className={cn("size-4", className)} {...iconProps} />
        },
