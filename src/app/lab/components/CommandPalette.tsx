      ...
      <Dialog.Positioner className="fixed inset-0 z-50 flex items-start justify-center px-4 pt-[25vh]">
        ...
        >
          ...
          <div className="flex items-center gap-3 border-b border-[#f5f5f5] px-4 py-3">
            ...
            />
            <kbd className="hidden items-center gap-1 rounded-lg bg-[#f9f9f9] px-2 py-0.5 font-mono text-[10px] text-[#767676] sm:flex">
              ESC
            </kbd>
          </div>
          ...
          <div className="max-h-[400px] overflow-y-auto p-2">
            ...
            {filteredCmds.length > 0 && (
              <div className="mb-2">
                <p className="px-2 py-1 text-[10px] font-semibold tracking-widest text-[#767676] uppercase">
                  Actions
                </p>
                {filteredCmds.map((cmd) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      {cmd.description && (
                        <p className="text-xs text-[#767676]">{cmd.description}</p>
                      )}
                    </div>
                  </button>
                ))}
