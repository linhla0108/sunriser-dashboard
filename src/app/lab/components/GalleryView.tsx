...
export default function GalleryView({
  ...
  return (
    <div>
      <div
        ref={gridRef}
        className="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6"
      >
        {paged.map((a) => (
          <GalleryCard
            key={a.id}
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: isSelected
          ? 'rgba(141,22,0,0.15) 0px 0px 0px 3px'
          : 'rgba(4, 23, 43, 0.04) 0px 2px 8px',
      }}
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: posColor.light }}
      >
        {/* Avatar */}
        <div
      ...
      {/* Card body */}
      <div className="p-3">
        <p className="mb-0.5 truncate text-xs leading-tight font-bold tracking-tight text-[#1b1b1b]">
          {a.name}
        </p>
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            ...
            style={{ color: a.gpa >= 8.5 ? '#16a34a' : a.gpa >= 7 ? '#555555' : '#767676' }}
          >
            {a.gpa.toFixed(1)}
          </span>
        </div>
        ...
        {r1Badge ? (
          ...
          <div className="mt-2">
            <span className="rounded-full bg-[#f9f9f9] px-1.5 py-0.5 text-[9px] font-medium text-[#767676]">
              New
            </span>
          </div>
        )}
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-1 border-t border-[#f5f5f5] py-2 text-[10px] font-semibold text-[#767676] opacity-0 transition-colors group-hover:opacity-100 hover:bg-[#ffdad3]/20 hover:text-[#8d1600]"
      >
        <Eye size={10} /> View
      </button>
    </div>
