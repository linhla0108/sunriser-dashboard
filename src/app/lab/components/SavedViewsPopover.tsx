...
export default function SavedViewsPopover({
  ...
  return (
    ...
    >
      <div className="p-3">
        <p className="mb-2 px-1 text-[10px] font-semibold tracking-widest text-[#6B5549] uppercase">
          Saved Views
        </p>
          ...
          <div className="mb-3 space-y-1">
            {savedViews.map((v) => {
              ...
              return (
                <div
                  key={v.id}
                  className="group flex items-center gap-2 rounded-xl px-2 py-2 hover:bg-[#f9f9f9]"
                >
