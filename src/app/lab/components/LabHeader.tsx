      ...
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span
                className="rounded-full bg-[#8d1600] px-2 py-0.5 font-bold text-[#ffdad3]"
                style={{ fontSize: '10px' }}
              >
                BETA
              </span>
        ...
        <div className="flex flex-shrink-0 items-center gap-2">
          ...
          >
            ...
            {filterCount > 0 && (
              <span
                className="flex h-4 w-4 items-center justify-center rounded-full bg-[#8d1600] font-bold text-white"
                style={{ fontSize: '10px' }}
              >
                {filterCount}
              </span>
