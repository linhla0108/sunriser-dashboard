...
function SortIcon({ k, sortKey, sortDir }: { k: SortKey; sortKey: SortKey; sortDir: SortDir }) {
  ...
  return sortDir === "asc" ? <ChevronUp size={11} className="text-[#8d1600]" /> : <ChevronDown size={11} className="text-[#8d1600]" />
}
          ...
          <thead>
            <tr className="border-b border-[#f9f9f9]">
              ...
              <th className="hidden px-3 py-3 text-left sm:table-cell">
                <span className="text-[10px] font-semibold tracking-widest text-[#555555] uppercase">Position</span>
              </th>
              ...
              <th className="hidden px-3 py-3 text-left lg:table-cell">
                <span className="text-[10px] font-semibold tracking-widest text-[#555555] uppercase">PIC</span>
              </th>
              <th className="px-3 py-3 text-left">
                <span className="text-[10px] font-semibold tracking-widest text-[#555555] uppercase">Round 1</span>
              </th>
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="min-w-0">
                        <p className="truncate text-sm font-semibold tracking-tight text-[#1b1b1b]">{a.name}</p>
                  ...
                  <td className="hidden px-3 py-3 lg:table-cell">
                    <span className="block max-w-[120px] truncate text-sm text-[#555555]">{a.university}</span>
                  </td>
