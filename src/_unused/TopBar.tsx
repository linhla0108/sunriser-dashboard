...
export default function TopBar({ title, subtitle, actions }: TopBarProps) {
  ...
  return (
    <div data-cid="topbar" className="mb-4 flex items-center justify-between">
      <div>
        <h1 className="font-bold tracking-tight text-[#1b1b1b]" style={{ fontSize: "var(--text-h1, 22px)" }}>
          {title}
        </h1>
        ...
        <div ref={menuRef} className="relative sm:hidden">
          ...
          {menuOpen && (
            <div
              ...
              style={{
                boxShadow: "rgba(4, 23, 43, 0.05) 0px 0px 0px 1px, rgba(0, 0, 0, 0.12) 0px 8px 24px",
              }}
            >
