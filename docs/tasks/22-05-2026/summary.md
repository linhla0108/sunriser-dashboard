...
| 4   | Upload Review Flow                             | upload/feature     | Done    | Authenticated Playwright smoke passed with provided dev account                                                |
| 5   | Candidate Table Row Selection and Bulk Actions | candidates/feature | Done    | Hover checkbox, selection-mode all-visible, cross-page persistent IDs, bulk Batch/PIC/Delete with confirmation |
