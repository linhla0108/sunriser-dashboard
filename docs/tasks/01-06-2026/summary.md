...
| --- | ---------------------------------------- | ---------------------- | ----------- | ----------------------------------------------------------------------------------------- |
| 1   | Contextual Right-Click Menu System       | workspace/feature      | Done        | Feature-specific menus instead of one global menu                                         |
...
| 9   | Header Announcement Popup Detail Modal   | announcements/feature  | Done        | Bell opens popup inbox with shared detail modal and deep-link support                     |
| 9   | Candidate Detail Modal                   | candidates/feature     | Done        | Candidate detail now opens in a centered modal with the existing content and note editing |
| 10  | Announcements Runtime Fix                | announcements/fix      | In Progress | Apply missing active-window schema and surface bell-center fetch errors                   |
